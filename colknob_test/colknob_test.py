...
def get_twiss(error):
	set_template("colknob_test.madx",error)
	os.system("../../madx colknob_test_temp.madx")	
...
def plot_colknob_percentage_comparison(error,savepath,colknob_value,start,steps):
	...
	for i in range(steps):
		...
		C_min1 = local_coupling(K1,betx_l[index_L1],bety_l[index_L1],mux_l[index_L1],muy_l[index_L1],l,Q1,Q2,theta_L1) +	local_coupling(K2,betx_l[index_R1],bety_l[index_R1],mux_l[index_R1],muy_l[index_R1],l,Q1,Q2,theta_R1)		  
	...
	for i in range(steps):
		...
		K1 = -float(colknob_value)*1e-4
		K2 = percentage_l[i] * float(colknob_value)*1e-4
		C_min5= local_coupling(K1,betx_l[index_L5],bety_l[index_L5],mux_l[index_L5],muy_l[index_L5],l,Q1,Q2,theta_L5) + local_coupling(K2,betx_l[index_R5],bety_l[index_R5],mux_l[index_R5],muy_l[index_R5],l,Q1,Q2,theta_R5)
